...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    socketRef.current.onmessage = (event) => {
      ...
      if (msg.type === "ALERT") {
        ...
        toast.error(`New Alert: ${msg.data.root_cause}`);
      }
    };
  ...
  // 1. AUTHENTICATION VIEW (Shown if not logged in)
  if (!isAuth) {
    return (
      <div style={authWrapperStyle}>
        <Toaster />
        <div style={authCardStyle}>
          <h2 style={{ color: "#38bdf8", marginBottom: "10px" }}>AI Ops Portal</h2>
          <p style={{ color: "#64748b", marginBottom: "25px" }}>
            {isLoginView ? "Sign in to monitor infrastructure" : "Create new operator account"}
          </p>
  ...
  // 2. DASHBOARD VIEW (Shown after login)
  return (
    <div style={dashboardLayoutStyle}>
      ...
      <main style={{ flex: 1, padding: "40px", overflowY: "auto" }}>
        <header style={{ display: "flex", justifyContent: "space-between", marginBottom: "30px" }}>
          ...
          <span style={liveBadgeStyle}>● LIVE MONITORING</span>
        </header>

        <div style={statsGridStyle}>
          <div style={statCardStyle}>
            <div style={statLabelStyle}>ACTIVE INCIDENTS</div>
        ...
        <section style={tableContainerStyle}>
          <h3 style={{ marginBottom: "20px", color: "#94a3b8" }}>Incident Log</h3>
...
const authCardStyle = { background: "#0f172a", padding: "40px", borderRadius: "16px", border: "1px solid #1e293b", width: "380px", textAlign: "center", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.5)" };
const formStyle = { display: "flex", flexDirection: "column", gap: "15px" };
const inputStyle = { padding: "12px", background: "#1e293b", border: "1px solid #334155", borderRadius: "8px", color: "white", outline: "none" };
const submitButtonStyle = { padding: "12px", background: "#38bdf8", color: "#0f172a", border: "none", borderRadius: "8px", fontWeight: "bold", cursor: "pointer" };
const toggleButtonStyle = { background: "none", border: "none", color: "#64748b", marginTop: "20px", cursor: "pointer", fontSize: "0.9rem" };
...
const navItemStyle = { padding: "12px", color: "#94a3b8", cursor: "pointer" };
const navActiveStyle = { ...navItemStyle, background: "#1e293b", borderRadius: "8px", color: "#38bdf8" };
const logoutButtonStyle = { padding: "10px", border: "1px solid #ef4444", color: "#ef4444", background: "transparent", borderRadius: "8px", cursor: "pointer" };
...
const tdStyle = { padding: "15px 12px", borderBottom: "1px solid #1e293b", fontSize: "0.9rem" };
const trStyle = { transition: "0.3s" };
const liveBadgeStyle = { background: "#064e3b", color: "#34d399", padding: "5px 15px", borderRadius: "20px", fontSize: "0.7rem", fontWeight: "bold" };
